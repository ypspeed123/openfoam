...
void Foam::BubbleGrowthCloud<CloudType>::setModels()
{
    dispersionModel_.reset
    (
        DispersionModel<BubbleGrowthCloud<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        PatchInteractionModel<BubbleGrowthCloud<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        StochasticCollisionModel<BubbleGrowthCloud<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        SurfaceFilmModel<BubbleGrowthCloud<CloudType>>::New
        (
            subModelProperties_,
            *this
        ).ptr()
...
void Foam::BubbleGrowthCloud<CloudType>::solve(TrackData& td)
{
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::buildCellOccupancy()
{
    ...
    forAllIter(typename BubbleGrowthCloud<CloudType>, *this, iter)
    {
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::updateCellOccupancy()
{
...
template<class CloudType>
template<class TrackData>
void Foam::BubbleGrowthCloud<CloudType>::evolveCloud(TrackData& td)
{
    if (solution_.coupled())
    {
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::postEvolve()
{
    Info<< endl;
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::cloudReset(BubbleGrowthCloud<CloudType>& c)
{
...
template<class CloudType>
Foam::BubbleGrowthCloud<CloudType>::BubbleGrowthCloud
(
...
template<class CloudType>
bool Foam::BubbleGrowthCloud<CloudType>::hasWallImpactDistance() const
{
    return true;
}
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::setParcelThermoProperties
(
    parcelType& parcel,
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::checkParcelProperties
(
    parcelType& parcel,
    const scalar lagrangianDt,
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::storeState()
{
    cloudCopyPtr_.reset
    (
        static_cast<BubbleGrowthCloud<CloudType>*>
        (
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::restoreState()
{
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::resetSourceTerms()
{
    UTrans().field() = Zero;
    UCoeff().field() = 0.0;
}
...
template<class CloudType>
template<class Type>
void Foam::BubbleGrowthCloud<CloudType>::relax
(
...
template<class CloudType>
template<class Type>
void Foam::BubbleGrowthCloud<CloudType>::scale
(
    DimensionedField<Type, volMesh>& field,
    const word& name
) const
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::relaxSources
(
    const BubbleGrowthCloud<CloudType>& cloudOldTime
)
{
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::scaleSources()
{
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::preEvolve()
{
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::evolve()
{
    if (solution_.canEvolve())
    {
        typename parcelType::template
            TrackingData<BubbleGrowthCloud<CloudType>> td(*this);
...
template<class CloudType>
template<class TrackData>
void Foam::BubbleGrowthCloud<CloudType>::motion(TrackData& td)
{
    td.part() = TrackData::tpLinearTrack;
    CloudType::move(td,  solution_.trackTime());
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::patchData
(
    const parcelType& p,
    const polyPatch& pp,
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::updateMesh()
{
    updateCellOccupancy();
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::autoMap(const mapPolyMesh& mapper)
{
    typedef typename particle::TrackingData<BubbleGrowthCloud<CloudType>> tdType;
...
template<class CloudType>
void Foam::BubbleGrowthCloud<CloudType>::info()
{

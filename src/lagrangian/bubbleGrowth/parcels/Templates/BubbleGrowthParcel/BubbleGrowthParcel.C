...
Foam::label Foam::BubbleGrowthParcel<ParcelType>::maxTrackAttempts = 1;
...
void Foam::BubbleGrowthParcel<ParcelType>::setCellValues
(
    TrackData& td,
    const scalar dt,
    const label celli
...
template<class ParcelType>
template<class TrackData>
void Foam::BubbleGrowthParcel<ParcelType>::cellValueSourceCorrection
(
    TrackData& td,
    const scalar dt,
    const label celli
...
template<class ParcelType>
template<class TrackData>
void Foam::BubbleGrowthParcel<ParcelType>::calc
(
    TrackData& td,
    const scalar dt,
    const label celli
...
template<class ParcelType>
template<class TrackData>
const Foam::vector Foam::BubbleGrowthParcel<ParcelType>::calcVelocity
(
    TrackData& td,
    const scalar dt,
    const label celli,
...
template<class ParcelType>
template<class TrackData>
bool Foam::BubbleGrowthParcel<ParcelType>::move
(
    TrackData& td,
...
)
{
	...
	scalar tNow=mesh.time().value(); // added for time update purpose
    while (td.keepParticle && !td.switchProcessor && tEnd > ROOTVSMALL)
    {
		...
		#include "solveRP_Mi.H"     //added for solve RP equation
...
template<class ParcelType>
template<class TrackData>
void Foam::BubbleGrowthParcel<ParcelType>::hitFace(TrackData& td)
{
    typename TrackData::cloudType::parcelType& p =
        static_cast<typename TrackData::cloudType::parcelType&>(*this);
...
template<class ParcelType>
void Foam::BubbleGrowthParcel<ParcelType>::hitFace(int& td)
{}


template<class ParcelType>
template<class TrackData>
bool Foam::BubbleGrowthParcel<ParcelType>::hitPatch
(
    const polyPatch& pp,
    TrackData& td,
    const label patchi,
...
template<class ParcelType>
template<class TrackData>
void Foam::BubbleGrowthParcel<ParcelType>::hitProcessorPatch
(
...
template<class ParcelType>
template<class TrackData>
void Foam::BubbleGrowthParcel<ParcelType>::hitWallPatch
(
...
template<class ParcelType>
template<class TrackData>
void Foam::BubbleGrowthParcel<ParcelType>::hitPatch
(
    const polyPatch&,
    TrackData& td
)
...
template<class ParcelType>
void Foam::BubbleGrowthParcel<ParcelType>::transformProperties(const tensor& T)
{
...
template<class ParcelType>
void Foam::BubbleGrowthParcel<ParcelType>::transformProperties
(
...
template<class ParcelType>
Foam::scalar Foam::BubbleGrowthParcel<ParcelType>::wallImpactDistance
(
    const vector&
) const
{
...
#include "BubbleGrowthParcelIO.C"

...
#include "BubbleGrowthLookupTableInjection.H"
#include "scalarIOList.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CloudType>
Foam::BubbleGrowthLookupTableInjection<CloudType>::BubbleGrowthLookupTableInjection
(
...
Foam::BubbleGrowthLookupTableInjection<CloudType>::BubbleGrowthLookupTableInjection
(
    const BubbleGrowthLookupTableInjection<CloudType>& im
)
:
...
template<class CloudType>
void Foam::BubbleGrowthLookupTableInjection<CloudType>::updateMesh()
{
    // Set/cache the injector cells
    forAll(injectors_, i)
    {
...
template<class CloudType>
Foam::scalar Foam::BubbleGrowthLookupTableInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
Foam::label Foam::BubbleGrowthLookupTableInjection<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::BubbleGrowthLookupTableInjection<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::BubbleGrowthLookupTableInjection<CloudType>::setPositionAndCell
(
    const label parcelI,
...
template<class CloudType>
void Foam::BubbleGrowthLookupTableInjection<CloudType>::setProperties
(
    const label parcelI,
    const label nParcels,
    const scalar,
...
template<class CloudType>
bool Foam::BubbleGrowthLookupTableInjection<CloudType>::fullyDescribed() const
{
    return true;
}
...
template<class CloudType>
bool Foam::BubbleGrowthLookupTableInjection<CloudType>::validInjection
(
    const label
)
{
